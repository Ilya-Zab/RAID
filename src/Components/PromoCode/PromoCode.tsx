...
const PromoCode = () => {
    return (
        <Box className="subtract-box">
            <h2>Install the game to get your Raid ID and take part in the competition  </h2>
            <Link
                href={'#'}
                className={`hexagon-button hexagon-button_gradient ${styles.promo__link}`}>
                Download RAID
            </Link>
            <p>A small appreciation gift for all players! Redeem promo code:</p>
            <Box className={styles.promo__code}>
