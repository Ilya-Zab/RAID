    ...
    return (
        <Box className={styles.wrapper}>
            <Box className={styles.modal}>
                ...
                <h3 className={styles.modal__title}>This webpage is under maintenance.</h3>
                <Box className={styles.modal__scrollbar}>
                    <ul className={styles.modal__list}>
                        <li>
                            We apologize for any inconvenience and appreciate your patience. We are working to bring this webpage back online as soon as possible
                        </li>
